...
//This code finds the large jet and (jet) b-tagged Higgs Boson mass usinf the bbww_x2000_s170 file
...
void a_2_x2000_s170(){
  ...
  auto file = TFile::Open("bbww_x2000_s170.root");
