...
//This code deals with the boosted analysis. H-> bb; ljet 1->W; ljet 2->W
...
void a_boosted(){
  ...
  auto h_M_inv_Higgs = new TH1F("M_inv_Higgs", "Invariant Mass of Higgs Boson; Mass[MeV]; Counts", nbins,0.0, 4.0e5);
  auto h_M_inv_W1 = new TH1F("M_inv_W1", "Invariant Mass of the first W Boson; Mass[MeV]; Counts", nbins, 0.0, 4.0e5);
  auto h_M_inv_W2 = new TH1F("M_inv_W2", "Invariant Mass of the second W Boson; Mass[MeV]; Counts", nbins, 0.0, 4.0e5);
  ...
  for (int i=0; i<nentries; i++)
  {
    ...
    int n_candidates=0;			//a step variable that counts the number of large jets
    cout << "beginning of i loop" << endl;
  ...
  file->Close();
  TFile f("a_boosted.root", "recreate");
  ...
  c = new TCanvas("c", "Boosted Analysis", 2000, 500);
  c -> Divide (3,1);
