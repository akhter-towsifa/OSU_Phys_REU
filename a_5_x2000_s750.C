...
//This code finds the large jet and Higgs Boson, S masses using the bbww_x2000_s750 file (large jet: 1H, >1 W's)
...
void a_5_x2000_s750(){
  ...
  auto file = TFile::Open("bbww_x2000_s750.root");
  ...
  for (int i=0; i<nentries; i++)			//loops over all the 20,000 entries.
  {
	...
	if(S.M() > 700e3 && S.M() < 800e3) h_S_totalnumber->Fill(S.M(), w);
