...
// Fri Jul 12 10:35:33 2019 by ROOT version 6.06/06
// from TTree CollectionTree/
// found on file: bbww_x2000_s1500.root
//////////////////////////////////////////////////////////

#ifndef CollectionTree1_h
#define CollectionTree1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           n_tjet;
   Float_t         tjet_pt[27];   //[n_tjet]
   Float_t         tjet_eta[27];   //[n_tjet]
   Float_t         tjet_phi[27];   //[n_tjet]
   Float_t         tjet_e[27];   //[n_tjet]
   Int_t           n_electrons;
   ...
   CollectionTree1(TTree *tree=0);
   virtual ~CollectionTree1();
...
#ifdef CollectionTree1_cxx
CollectionTree1::CollectionTree1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("bbww_x2000_s1500.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("bbww_x2000_s1500.root");
      }
...
CollectionTree1::~CollectionTree1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CollectionTree1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CollectionTree1::LoadTree(Long64_t entry)
{
...
void CollectionTree1::Init(TTree *tree)
{
...
void CollectionTree1::Show(Long64_t entry)
{
...
Int_t CollectionTree1::Cut(Long64_t entry)
{
...
#endif // #ifdef CollectionTree1_cxx
